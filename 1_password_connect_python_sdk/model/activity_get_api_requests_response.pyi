...
class ActivityGetApiRequestsResponse(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['APIRequest']:
            return APIRequest

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['APIRequest'], typing.List['APIRequest']],
    ...
    def __getitem__(self, i: int) -> 'APIRequest':

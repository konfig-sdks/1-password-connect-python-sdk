...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'fileUuid': typing.Union[FileUuidSchema, str, uuid.UUID, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = FileSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_file_details_mapped_args(
        self,
        vault_uuid: str,
        item_uuid: str,
        file_uuid: str,
    ...
    async def _aget_file_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/vaults/{vaultUuid}/items/{itemUuid}/files/{fileUuid}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetFileDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_file_details(
        self,
        vault_uuid: str,
        item_uuid: str,
        file_uuid: str,
        ...
        **kwargs,
        ...
        args = self._get_file_details_mapped_args(
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
            file_uuid=file_uuid,
            inline_files=inline_files,
        )
        return await self._aget_file_details_oapg(
    ...
    def get_file_details(
        ...
        return self._get_file_details_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFileDetails(BaseApi):
    ...
    async def aget_file_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_file_details(
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
            file_uuid=file_uuid,
            inline_files=inline_files,
    ...
    def get_file_details(
        ...
        raw_response = self.raw.get_file_details(
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
            file_uuid=file_uuid,
            inline_files=inline_files,

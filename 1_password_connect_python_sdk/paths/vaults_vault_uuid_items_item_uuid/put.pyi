...
class BaseApi(api_client.Api):
    ...
    def _update_item_details_mapped_args(
        self,
        vault_uuid: str,
        item_uuid: str,
    ...
    async def _aupdate_item_details_oapg(
        self,
...
class UpdateItemDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_item_details(
        self,
        vault_uuid: str,
        item_uuid: str,
        tags: typing.Optional[ItemTags] = None,
        ...
        **kwargs,
        ...
        args = self._update_item_details_mapped_args(
            body=body,
        ...
        return await self._aupdate_item_details_oapg(
            body=args.body,
    ...
    def update_item_details(
        ...
        return self._update_item_details_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateItemDetails(BaseApi):
    ...
    async def aupdate_item_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_item_details(
            body=body,
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
            tags=tags,
    ...
    def update_item_details(
        ...
        raw_response = self.raw.update_item_details(
            body=body,
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
            tags=tags,

...
from 1_password_connect_python_sdk.model.patch import Patch as PatchSchema

from 1_password_connect_python_sdk.type.error_response import ErrorResponse
from 1_password_connect_python_sdk.type.patch import Patch
from 1_password_connect_python_sdk.type.full_item import FullItem

from ...api_client import Dictionary
from 1_password_connect_python_sdk.pydantic.patch import Patch as PatchPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PatchSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_subset_attributes_mapped_args(
        self,
        vault_uuid: str,
        item_uuid: str,
        body: typing.Optional[Patch] = None,
    ...
    async def _aupdate_subset_attributes_oapg(
        self,
    ...
    def _update_subset_attributes_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSubsetAttributesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_subset_attributes(
        self,
        vault_uuid: str,
        item_uuid: str,
        body: typing.Optional[Patch] = None,
        **kwargs,
        ...
        args = self._update_subset_attributes_mapped_args(
            body=body,
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
        )
        return await self._aupdate_subset_attributes_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_subset_attributes(
        self,
        vault_uuid: str,
        item_uuid: str,
        body: typing.Optional[Patch] = None,
        ...
        return self._update_subset_attributes_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSubsetAttributes(BaseApi):
    ...
    async def aupdate_subset_attributes(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_subset_attributes(
            body=body,
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
            **kwargs,
    ...
    def update_subset_attributes(
        ...
        raw_response = self.raw.update_subset_attributes(
            body=body,
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
        )

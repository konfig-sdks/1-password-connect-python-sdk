...
class BaseApi(api_client.Api):
    ...
    def _delete_item_by_id_mapped_args(
        self,
        vault_uuid: str,
        item_uuid: str,
    ...
    async def _adelete_item_by_id_oapg(
        self,
...
class DeleteItemByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_item_by_id(
        self,
        vault_uuid: str,
        item_uuid: str,
        **kwargs,
        ...
        args = self._delete_item_by_id_mapped_args(
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
        )
        return await self._adelete_item_by_id_oapg(
    ...
    def delete_item_by_id(
        ...
        return self._delete_item_by_id_oapg(
            path_params=args.path,
        )

class DeleteItemById(BaseApi):
    ...
    async def adelete_item_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_item_by_id(
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
            **kwargs,
        )
    ...
    def delete_item_by_id(
        ...
        raw_response = self.raw.delete_item_by_id(
            vault_uuid=vault_uuid,
            item_uuid=item_uuid,
        )

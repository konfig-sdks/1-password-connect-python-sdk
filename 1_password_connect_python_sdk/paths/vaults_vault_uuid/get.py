...
from 1_password_connect_python_sdk.model.vault import Vault as VaultSchema
...
from 1_password_connect_python_sdk.type.vault import Vault

from ...api_client import Dictionary
from 1_password_connect_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from 1_password_connect_python_sdk.pydantic.vault import Vault as VaultPydantic
...
SchemaFor200ResponseBodyApplicationJson = VaultSchema
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/vaults/{vaultUuid}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        **kwargs,
        ...
        if validate:
            return VaultPydantic(**raw_response.body)
        return api_client.construct_model_instance(VaultPydantic, raw_response.body)

    ...
    async def _acheck_liveness_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/heartbeat',
            headers=_headers,
        )
    
        host = self._get_host_oapg('check_liveness', _servers, host_index)
...
class CheckLivenessRaw(BaseApi):
...
class CheckLiveness(BaseApi):
    ...
    async def acheck_liveness(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_liveness(
            **kwargs,
        )
        if validate:
    ...
    def check_liveness(
        ...
        raw_response = self.raw.check_liveness(
        )
        if validate:
            return RootModel[str](raw_response.body).root
        return raw_response.body

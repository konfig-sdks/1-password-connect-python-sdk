...
from 1_password_connect_python_sdk.model.vaults_list_all_response import VaultsListAllResponse as VaultsListAllResponseSchema

from 1_password_connect_python_sdk.type.vaults_list_all_response import VaultsListAllResponse
from 1_password_connect_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from 1_password_connect_python_sdk.pydantic.vaults_list_all_response import VaultsListAllResponse as VaultsListAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = VaultsListAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VaultsListAllResponse
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VaultsListAllResponsePydantic:
        raw_response = await self.raw.alist_all(
            filter=filter,
            **kwargs,
        )
        if validate:
            return RootModel[VaultsListAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(VaultsListAllResponsePydantic, raw_response.body)

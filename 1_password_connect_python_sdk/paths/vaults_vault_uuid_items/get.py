...
from 1_password_connect_python_sdk.model.items_get_all_response import ItemsGetAllResponse as ItemsGetAllResponseSchema
...
from 1_password_connect_python_sdk.type.items_get_all_response import ItemsGetAllResponse

from ...api_client import Dictionary
from 1_password_connect_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from 1_password_connect_python_sdk.pydantic.items_get_all_response import ItemsGetAllResponse as ItemsGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ItemsGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ItemsGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[ItemsGetAllResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ItemsGetAllResponsePydantic, raw_response.body)
